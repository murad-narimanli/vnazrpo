...
@section('header')
    ...
    <link rel="stylesheet" href="{{asset('assets/agency/business.css?cssv=4')}}">
@endsection
                ...
                <div class="agency-container container">
                    ...
                    <div class="agency-card-section">
                        <div class="agency-title">
                            <h3>{{T("Bizness mərkərləri")}}</h3>
                        </div>

                        <div class="agency-flex-cards container business__flex-cards">
                            @foreach($businesCenter as $value)
                                <div class="agency-card col-xs-12 business__card"
                                    ...
                                    @endif
                                    <button class="request-btn business__button">{{\App\Models\Announcement::where('data.status', 'ACTIVE')->where('data.merchant', $value['_id'])->count()}}
                                        {{T("Təklif")}}
                                    </button>
                                </div>
                            @endforeach
