                ...
                <div class="agency-inner-container container">
                        ...
                        <div class="agency-inner-section-first-left-flex">
                            <div class="agency-inner-section-first-left">
                                <div class="agency-inner-section-first-left-image">
                                    <figure>
                                        <img
                                            src="http://evinaznew.cms.kube.tisserv.net/upload/crop/300/168/{{@$makler['data']['images'][0]['path']}}"
                                            alt="">
                                    </figure>
                                </div>

                                <div class="agency-inner-section-first-left-information">
                                    <h3>{{$makler['data']['fullname']}}</h3>
                                    <div>
                                        {!! $makler['data']['bio'] ?? '' !!}
                                    </div>
                                    <p class="agency-inner-section-first-left-information-bottom">{{\App\Models\Announcement::where('data.status', 'ACTIVE')->where('data.merchant', $id)->count()}} {{T("Təklif")}}</p>
                                </div>
                            </div>
                    ...
                    <div>
                        <div class="agency-section-inner-nav">
                            <ul>
                                <li><a href="{{langUrlPrefix()}}/makler/{{$id}}">Hamısı</a></li>
                                @foreach($types as $value)
                                    <li>
                                        <a href="{{langUrlPrefix()}}/makler/{{$id}}/{{$value['_id']}}">{{$value['data']['title'][App::getLocale()] ?? ''}}</a>
                                    </li>
                                @endforeach
                        ...
                        <div class="last-section-cards-flex mb-5 container rent__flex-cards">
                            @foreach($objects as $value)
                                <div
                                    class="last-section-card mb-4  justify-content-inithal object-container rent__object"
                                    data-id="{{$value['_id']}}"
                                    ...
                                    <div class="last-section-card-content ">
                                        ...
                                        <div
                                            class="last-section-second-row px-3 justify-content-between custom__second-row">
                                        ...
                                        <div
                                            class="last-section-third-row custom__card-footer px-3 customFooter justify-content-between rent__card-footer">
                                            <h4 class="price-dots d-sm-block d-none"
                                                id="price">{{$value['data']['price']}} {{\App\Models\CurrencyType::find($value['data']['currency'])->data['title'][App::getLocale()] ?? ''}}</h4>
                                            <div class="stars2">
