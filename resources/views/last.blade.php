...
@section('header')
    ...
    <link rel="stylesheet" href="{{asset('assets/last/last-custom.css?cssv=4')}}">
                    ...
                    <div>
                        <div class="last-ads-cards-section">
                            <div class="last-ads-title">
                                <h3>{{$headingTitle}} ({{count($objects)}})</h3>
                            </div>
                            <div class="last-ads-cards-section-selection">
                                <div class="last-ads-cards-section-buttons">
                                    <button class="last-ads-cards-section-button-list"
                                            onclick="hideSearchMap('testMap')"><i class="fas fa-list"></i>
                                        <p>
                                            {{T("Siyahı")}}</p></button>
                                    <button class="last-ads-cards-section-button-map" onclick="showMyMap('testMap')"><i
                                            class="fas fa-map-marked-alt"></i>
                                        <p>{{T("Xəritə")}}</p></button>
                                </div>

                                    <div class="last-ads-cards-section-buttons-selection ">
                                      <div class="form-div custom-common-select sort px-2 w-100 my-0 h-100 custom__form-item" id="first-div">
                        ...
                        <div class="ads-list">
                        <div class="last-section-cards-flex custom__cards-flex ">
                            @foreach($objects as $value)
                                <div class="last-section-card mb-4 object-container custom__last-cards"
                                     data-id="{{$value['_id']}}"
                                    ...
                                    <div class="vip-card-header">
                                        ...
                                        @if(isset($value['data']['images']))
                                            <div class="vip-card-slider">
                                                <figure>
                                                    <img
                                                        src="http://evinaznew.cms.kube.tisserv.net/upload/crop/700/641/{{$value['data']['images'][0]['path'] ?? ''}}"
                                                        alt="">
                                                </figure>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="last-section-card-title d-sm-block d-none">
                                    ...
                                    <div class="last-section-card-content ">
                                        <div class="d-sm-flex d-none px-3 mt-3 ">
                                        ...
                                        <div
                                            ...
                                            <div class="ml-0">
                                                <span class="item-hidden-icon"><img src="/assets/icons/floor.svg"
                                                                                    alt=""></span>
                                                <p class="f-12 custom__before-dot">{{$value['data']['current-floor'] ?? 1}}
                                                    /{{$value['data']['total-floors'] ?? 1}}
                                                    <span>{{T("mərtəbə")}}</span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="last-section-second-row d-flex justify-content-between second-row">
                                            <div class='d-sm-flex  d-none'>
                                                <span class="item-hidden-icon">
                                                    <img src="/assets/icons/floor.svg" alt="">
                                                </span>
                                                <p class="rent__before-dot">{{$value['data']['current-floor'] ?? 1}}
                                                    /{{$value['data']['total-floors'] ?? 1}}
                                                    <span class="floor-span">{{T("mərtəbə")}}</span>
                                                </p>
                                            </div>

                                            <div class="last-section-date d-sm-block d-none custom__card-date">
                                        ...
                                        <div
                                            class="last-section-third-row px-3 justify-content-between third-row custom__card-footer">
                                            <h4 class="d-sm-block price-dots d-none ">{{@$value['data']['price'] ?? ''}} {{@\App\Models\CurrencyType::find($value['data']['currency'])->data['title'][App::getLocale()] ?? ''}}</h4>
                                            <div class="stars2">
                            ...
                            <div class="w-100">{{ $objects->links() }}</div>
                        </div>
                        </div>


                        {{-- <div id="last-search-map" style="margin-top: 20px; display: none; width: 100%; height: 641px;"></div> --}}
                        <div style='margin-bottom: 50px; opacity:0; width: 100%; height: 0px;' id="testMap">
